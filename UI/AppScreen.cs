...
namespace BankApp.UI
{
    public class AppScreen
    {
        ...
        internal static UserAccount  UserLoginForm()
        {
            ...
            tempUserAccount.UserName = Validator.Convert<string>("Your username.");
            tempUserAccount.Password = Utility.GetSecretInput("Enter your card PIN");
        ...
        {
            Utility.PrintMessage($"Welcome back, {fullName}!", true);
            //Utility.PressEnterToContinue();
        }
        ...
        {
            Console.Clear();
            Console.WriteLine("-------TOM BANK APP Menu-------");
            Console.WriteLine(":                           :");
        ...
        {
            Console.WriteLine("Thank you for using TOM BANK APP.");
            Utility.PrintDotAnimation();
            Console.Clear();
        }
